...
lb1=Label(root,text="PASSWORD GENERATOR",bg="skyblue",font="arial 18").pack()

lb2=Label(root,bg="pink",text="Enter user name").place(x=15,y=54)
e1=Entry(root,width=10,textvariable=user_name).place(x=200,y=55)

lb3=Label(root,bg="pink",text="Enter the length of the password").place(x=15,y=97)
e2=Entry(root,width=10,textvariable=pwd_len).place(x=200,y=100)

lb4=Label(root,bg="pink",text="Genterated Password").place(x=15,y=140)
e3=Entry(root,textvariable=passstr,width=30).place(x=200,y=140)

bt1=Button(root,bg="orange",text="Generate password",command=get_pass).place(x=140,y=200)
